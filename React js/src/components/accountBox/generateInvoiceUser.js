...
function GenerateInvoiceUser(){
    ...
    return(
        ...
        <main className="m-5 p-5 md:max-w-xl md:mx-auto lg:max-w-2xl xl:max-w-4xl bg-white rounded shadow">
          ...
          <button className="m-2 rounded mt-5 mb-3 btn-outline-success text-gray fw-bold py-2 px-8 shadow border-2 border-success hover:bg-transparent hover:text-success-500 transition-all duration-300 p-2 "  
...
{/* 
      ...
      /> */}
           ...
           <ReactToPrint 
            ...
            <header className="d-flex mb-5 flex-row justify-content-center"  handlePrint={handlePrint}>
            <div>
            <h1 className=" font-bold text-uppercase tracking-wide fw-bold text-4xl mb-3 flex-column">BillEzy Bill</h1>
            </div>
            </header> 
...
export default GenerateInvoiceUser;